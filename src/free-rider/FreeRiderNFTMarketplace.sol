...
contract FreeRiderNFTMarketplace is ReentrancyGuard {
    ...
    function _buyOne(uint256 tokenId) private {
        ...
        //note(tina): this only check if msg.value is enough for one NFT, not all NFTs
        ...
        //NOTE (tina): this does not mean paying the seller it means paying the BUYER now that the tokens are transfered to the buyer from the line above
